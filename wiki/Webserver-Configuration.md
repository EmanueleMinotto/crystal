...
<configuration>
    <system.webServer>
        ...
        <rewrite>
            <rules>
                <rule name="Crystal Front Controller" stopProcessing="true">
...
PHP ships with a built-in webserver for development. This server allows you to run crystal without any configuration.
